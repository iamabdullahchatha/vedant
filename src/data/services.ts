...
export const SERVICES: ServiceDef[] = [
  {
    ...
    capabilities: ["Technology & architecture assessments", "IT strategy & roadmap development", "Vendor & platform selection", "Cost optimization and TCO modeling"],
    benefits: ["Faster, better-informed technology decisions", "Reduced risk on major platform investments", "Clear alignment between IT and business strategy"],
  },
  {
    ...
    capabilities: ["Digital maturity assessment", "Process re-engineering", "Legacy modernization", "Change management & adoption"],
    benefits: ["Accelerated time-to-market", "Lower operating cost through automation", "Improved customer and employee experience"],
  },
  {
    ...
    capabilities: ["Solution architecture & design", "Full-stack engineering", "API & microservices development", "Enterprise systems integration"],
    benefits: ["Software that scales with the business", "Reduced technical debt from day one", "Faster delivery without sacrificing quality"],
  },
  {
    ...
    capabilities: ["Web & mobile application development", "UX/UI design", "API development", "Performance & scalability engineering"],
    benefits: ["Shorter development cycles", "Consistent quality across releases", "Applications ready for global scale"],
  },
  {
    ...
    capabilities: ["L1/L2/L3 application support", "Patch & version management", "Performance monitoring & tuning", "Enhancement & minor development"],
    benefits: ["Higher application uptime", "Lower total cost of ownership", "Freed internal capacity for innovation"],
  },
  {
    ...
    capabilities: ["24/7 infrastructure & application monitoring", "Service desk & end-user support", "Patch, backup & DR management", "SLA-driven operations"],
    benefits: ["Predictable operating costs", "Reduced downtime and incident volume", "Access to specialist skills on demand"],
  },
  {
    ...
    capabilities: ["Test strategy & planning", "Functional & regression testing", "Performance & load testing", "Usability & accessibility testing"],
    benefits: ["Fewer production defects", "Faster, safer release cycles", "Higher user satisfaction"],
  },
  {
    ...
    capabilities: ["Test automation framework design", "CI/CD-integrated test pipelines", "API & UI test automation", "Cross-browser & cross-device testing"],
    benefits: ["Dramatically faster regression cycles", "Consistent quality at release velocity", "Lower long-term testing cost"],
  },
  {
    slug: "cloud-services",
    name: "Cloud Services",
    ...
    capabilities: ["Cloud architecture & landing zones", "Multi-cloud & hybrid strategy", "Cloud-native application design", "FinOps & cost optimization"],
    benefits: ["Lower infrastructure cost", "Improved scalability and resilience", "Faster provisioning and deployment"],
  },
  {
    ...
    capabilities: ["Migration readiness assessment", "Application & data migration", "Re-platforming & re-architecture", "Cutover & rollback planning"],
    benefits: ["Minimal business disruption", "Reduced migration risk", "Faster realization of cloud economics"],
  },
  {
    slug: "devops",
    name: "DevOps",
    ...
    capabilities: ["CI/CD pipeline engineering", "Infrastructure as Code", "Containerization & orchestration", "Observability & monitoring"],
    benefits: ["Faster, more frequent releases", "Reduced deployment failures", "Improved developer productivity"],
  },
  {
    slug: "cyber-security",
    name: "Cyber Security",
    ...
    capabilities: ["Security architecture & zero-trust design", "SOC & threat monitoring", "Vulnerability & penetration testing", "Secure SDLC & compliance"],
    benefits: ["Reduced breach risk and exposure", "Stronger regulatory compliance posture", "Faster detection and response times"],
  },
  {
    slug: "data-analytics",
    name: "Data Analytics",
    ...
    capabilities: ["Data pipeline engineering", "Predictive & descriptive analytics", "Dashboard & reporting design", "Data governance & quality"],
    benefits: ["Faster, evidence-based decisions", "Higher data quality and trust", "Measurable ROI on data investment"],
  },
  {
    slug: "big-data",
    name: "Big Data",
    ...
    capabilities: ["Big data architecture & platform design", "Batch & streaming data pipelines", "Data lake & lakehouse implementation", "Distributed processing (Spark, Kafka)"],
    benefits: ["Ability to process enterprise-scale data", "Real-time insight from streaming sources", "Lower cost per terabyte processed"],
  },
  {
    ...
    capabilities: ["BI platform implementation", "Self-service dashboard design", "Data modeling & semantic layers", "KPI & metrics framework design"],
    benefits: ["Faster access to trusted metrics", "Reduced reliance on manual reporting", "Wider data-driven decision-making"],
  },
  {
    ...
    capabilities: ["Infrastructure architecture & design", "Data center & hybrid cloud management", "Network & storage engineering", "Disaster recovery & business continuity"],
    benefits: ["Higher infrastructure reliability", "Improved disaster recovery posture", "Optimized infrastructure spend"],
  },
  {
    ...
    capabilities: ["AI strategy & use-case discovery", "Generative AI & LLM solutions", "Computer vision & NLP", "AI governance & responsible AI"],
    benefits: ["Faster path from AI pilot to production", "Governed, auditable AI outcomes", "Measurable business impact from AI"],
  },
  {
    ...
    capabilities: ["Model design & development", "Feature engineering & data pipelines", "MLOps & model deployment", "Model monitoring & retraining"],
    benefits: ["Higher model accuracy in production", "Faster model deployment cycles", "Reduced model drift and downtime"],
  },
  {
    ...
    capabilities: ["Process discovery & assessment", "Bot design & development", "RPA + AI (intelligent automation)", "Bot governance & monitoring"],
    benefits: ["Significant reduction in manual effort", "Fewer process errors", "Faster process turnaround times"],
  },
  {
    slug: "iot",
    name: "IoT",
    ...
    capabilities: ["IoT architecture & platform design", "Device connectivity & edge computing", "Sensor data pipelines", "Predictive maintenance solutions"],
    benefits: ["Real-time operational visibility", "Reduced unplanned downtime", "Data-driven maintenance decisions"],
  },
  {
    slug: "blockchain",
    name: "Blockchain",
    ...
    capabilities: ["Blockchain architecture & design", "Smart contract development", "Supply chain traceability solutions", "Private & consortium blockchain networks"],
    benefits: ["Verifiable, tamper-proof transaction records", "Reduced reconciliation overhead", "Greater trust across multi-party networks"],
  },
  {
    ...
    capabilities: ["Automation architecture & control system design", "Production line integration", "OT/IT convergence", "Industry 4.0 implementation"],
    benefits: ["Higher production throughput", "Reduced unplanned downtime", "Improved product quality and consistency"],
  },
  {
    ...
    capabilities: ["Robotic & motion control integration", "Automated line design", "Control system programming", "Production data integration"],
    benefits: ["Increased manufacturing efficiency", "Lower labor and rework cost", "Consistent, repeatable production quality"],
  },
  {
    slug: "plc",
    name: "PLC",
    ...
    capabilities: ["PLC programming & commissioning", "Control panel design", "HMI development", "System troubleshooting & optimization"],
    benefits: ["Reliable, deterministic process control", "Reduced commissioning timelines", "Lower long-term maintenance cost"],
  },
  {
    slug: "scada",
    name: "SCADA",
    ...
    capabilities: ["SCADA architecture & design", "Real-time monitoring dashboards", "Alarm management systems", "Remote asset connectivity"],
    benefits: ["Real-time operational visibility", "Faster incident response", "Centralized control of distributed assets"],
  },
  {
    slug: "dcs",
    name: "DCS",
    ...
    capabilities: ["DCS architecture & configuration", "Process control loop tuning", "System migration & upgrades", "Redundancy & failover design"],
    benefits: ["Improved process stability", "Higher plant availability", "Safer, more precise process control"],
  },
  {
    slug: "mes",
    name: "MES",
    ...
    capabilities: ["MES implementation & integration", "Production tracking & scheduling", "Quality & compliance management", "ERP-MES integration"],
    benefits: ["Real-time production visibility", "Improved quality traceability", "Tighter plant-to-enterprise alignment"],
  },
  {
    slug: "sap",
    name: "SAP",
    ...
    capabilities: ["SAP S/4HANA implementation & migration", "SAP module consulting (FI/CO, MM, SD, PP)", "SAP integration & custom development", "SAP managed services"],
    benefits: ["Streamlined core business processes", "Reduced SAP total cost of ownership", "Faster, lower-risk SAP upgrades"],
  },
  {
    ...
    capabilities: ["Salesforce roadmap & strategy", "Org architecture assessment", "Multi-cloud Salesforce design", "Adoption & governance planning"],
    benefits: ["Clearer Salesforce investment roadmap", "Reduced technical debt in the org", "Higher user adoption rates"],
  },
  {
    ...
    capabilities: ["Sales & Service Cloud implementation", "Custom Salesforce app development", "Data migration & configuration", "User training & enablement"],
    benefits: ["Faster time-to-value on Salesforce", "Fewer post-launch defects", "Higher confidence at go-live"],
  },
  {
    ...
    capabilities: ["API & middleware integration", "Salesforce-ERP integration", "Real-time data synchronization", "Integration monitoring & support"],
    benefits: ["Unified, accurate customer data", "Reduced manual data entry", "Faster cross-system processes"],
  },
  {
    slug: "crm-solutions",
    name: "CRM Solutions",
    ...
    capabilities: ["CRM strategy & platform selection", "Custom CRM configuration", "Sales & service process design", "CRM data migration & cleanup"],
    benefits: ["Higher CRM adoption and data quality", "Improved sales and service productivity", "Better customer visibility across teams"],
  },
  {
    slug: "hr-recruitment",
    name: "HR Recruitment",
    ...
    capabilities: ["Technical talent sourcing", "Screening & competency assessment", "Executive & specialist search", "Recruitment process outsourcing (RPO)"],
    benefits: ["Faster time-to-hire", "Higher quality of candidate match", "Reduced recruitment overhead"],
  },
  {
    ...
    capabilities: ["Role scoping & market benchmarking", "Candidate sourcing & shortlisting", "Interview coordination & assessment", "Offer management & onboarding support"],
    benefits: ["Access to a global specialist talent pool", "Reduced hiring cycle time", "Lower cost-per-hire"],
  },
  {
    ...
    capabilities: ["Rapid specialist mobilization", "Flexible contract durations", "Skills-matched staffing", "Compliance & payroll management"],
    benefits: ["Fast access to specialist skills", "Flexible scaling up or down", "Reduced administrative burden"],
  },
  {
    ...
    capabilities: ["Global workforce strategy", "Managed team delivery", "Multi-country compliance & payroll", "Talent pipeline development"],
    benefits: ["Single partner for global workforce needs", "Consistent quality across geographies", "Reduced complexity of multi-country hiring"],
  },
];
